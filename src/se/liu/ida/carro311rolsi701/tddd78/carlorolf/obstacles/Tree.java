...
public class Tree extends ArenaObject {
    ...
    public Tree(final double x, final double y, final double diameter, CollisionHandler collisionHandler, Arena arena) {
        ...
        final int leavesImageWidth = Images.getImage("leaves").getWidth(null);
        final int leavesImageHeight = Images.getImage("leaves").getHeight(null);
        final int stumpWidth = Images.getImage("tree").getWidth(null);
        final int stumpHeight = Images.getImage("tree").getHeight(null);
