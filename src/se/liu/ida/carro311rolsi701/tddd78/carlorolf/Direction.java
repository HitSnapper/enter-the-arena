...
public enum Direction
{
    ...
    @SuppressWarnings("JavaDoc")NORTH(new Vector(0, -1)), @SuppressWarnings("JavaDoc")SOUTH(
	new Vector(0, 1)), @SuppressWarnings("JavaDoc")EAST(new Vector(1, 0)), @SuppressWarnings("JavaDoc")WEST(
	new Vector(-1, 0)),
    @SuppressWarnings("JavaDoc")NORTHWEST(new Vector(-1, -1)), @SuppressWarnings("JavaDoc")NORTHEAST(
	new Vector(1, -1)), @SuppressWarnings("JavaDoc")SOUTHWEST(new Vector(-1, 1)), @SuppressWarnings("JavaDoc")SOUTHEAST(
	new Vector(1, 1)),
